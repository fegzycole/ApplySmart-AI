...
export function OptimizerHeader() {
  return (
    <div className="mb-6 lg:mb-8">
      ...
      <h1 className="text-xl sm:text-4xl font-bold mb-2 leading-tight">
        <span className="bg-gradient-to-r from-violet-600 via-fuchsia-600 to-cyan-600 bg-clip-text text-transparent">
          Resume Optimizer
        </span>
      </h1>
      <p className="max-w-3xl text-zinc-600 dark:text-zinc-400 text-xs sm:text-base lg:text-lg">
        Enhance your resume with AI to match job requirements perfectly
      </p>
    </div>
  );
}
