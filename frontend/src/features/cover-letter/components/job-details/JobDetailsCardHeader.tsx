...
export function JobDetailsCardHeader() {
  return (
    <div className="flex items-center gap-4 sm:gap-6">
      <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-amber-500 text-white shadow-2xl shadow-amber-500/30 sm:h-16 sm:w-16 sm:rounded-2xl">
      ...
      <div>
        <h3 className="text-xl font-black tracking-tighter text-zinc-900 dark:text-zinc-50 uppercase leading-none sm:text-2xl">
