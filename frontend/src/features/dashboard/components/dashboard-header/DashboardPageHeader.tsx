        ...
        <div className="flex items-center gap-6">
           ...
           <div className="flex items-center gap-4">
              <div className="flex flex-col">
                 ...
                 <span className="text-sm font-black uppercase tracking-tighter text-zinc-900 dark:text-zinc-50 mt-1">Alpha-User-01</span>
              </div>
        ...
        <div className="relative z-10 flex items-center gap-8">
          ...
          <div className="flex flex-col items-end gap-4 min-w-[140px]">
            ...
            <div className="flex flex-col items-end gap-2">
              <div className="flex items-center gap-3">
                <span className="text-3xl font-black tabular-nums text-zinc-900 dark:text-zinc-50 tracking-tighter">78<span className="text-sky-500">%</span></span>
                <div className="h-10 w-px bg-zinc-100 dark:bg-zinc-800" />
                <div className="flex flex-col items-start">
                   <span className="text-[10px] font-black uppercase text-emerald-500 tracking-widest">Optimal</span>
