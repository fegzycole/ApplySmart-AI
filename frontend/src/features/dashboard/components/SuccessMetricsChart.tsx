...
const successMetrics = [
  { month: "Jan", responseRate: 25, interviewRate: 25, offerRate: 8.3 },
  { month: "Feb", responseRate: 21, interviewRate: 21, offerRate: 0 },
  { month: "Mar", responseRate: 33, interviewRate: 33, offerRate: 13.3 },
  { month: "Apr", responseRate: 24, interviewRate: 24, offerRate: 4 },
  { month: "May", responseRate: 23, interviewRate: 23, offerRate: 9.1 },
  { month: "Jun", responseRate: 27, interviewRate: 27, offerRate: 10 },
];
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <CardTitle className="text-lg sm:text-xl">Success Metrics Trend</CardTitle>
            <CardDescription className="text-xs sm:text-sm">Response, interview, and offer rates over time</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="pb-6">
        <div className="w-full h-72 sm:h-80">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={successMetrics} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              <defs>
