...
export function DashboardStatusBadge({ status }: { status: DashboardApplicationStatus }) {
  ...
  return (
    <span className={cn(
      "inline-flex items-center gap-2 rounded-full border border-zinc-200/50 bg-white px-3 py-1.5 text-[10px] font-black uppercase tracking-widest shadow-sm dark:border-zinc-800/60 dark:bg-zinc-900/60",
      config.className,
    )}>
