...
public interface CoverLetterService {
    ...
    CoverLetterResponseDto generateCoverLetter(MultipartFile resumeFile, String jobDescription, String companyName,
    ...
    Page<CoverLetterResponseDto> getAllCoverLetters(User user, Pageable pageable, String query);
